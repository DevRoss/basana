...
class FuturesAccount:
    ...
    async def get_account_information(self) -> dict:
        return await self._client.make_request("GET", "/fapi/v2/account", send_sig=True)
    ...
    async def cancel_order(
        ...
        return await self._client.make_request("DELETE", "/fapi/v3/order", qs_params=params, send_sig=True)

    async def get_trades(self, symbol: str, order_id: Optional[int] = None) -> List[dict]:
        params: Dict[str, Any] = {"symbol": symbol}
        if order_id is not None:
            params["orderId"] = order_id
        return await self._client.make_request("GET", "/fapi/v3/myTrades", qs_params=params, send_sig=True)
    ...
    async def create_oco(
        ...
        params.update(kwargs)
        return await self._client.make_request("POST", "/fapi/v3/order/oco", data=params, send_sig=True)
    ...
    async def cancel_oco_order(
        ...
        return await self._client.make_request("DELETE", "/fapi/v3/orderList", data=params, send_sig=True)
    ...
    async def query_oco_order(
        ...
        return await self._client.make_request("GET", "/fapi/v3/orderList", qs_params=params, send_sig=True)
